"""
Period utility functions for calculating and managing financial periods.

This module handles all period-related calculations including:
- Current period dates calculation
- Period change impact analysis
- Period configuration changes
- Available periods listing
"""
...
from ..models import Period, FlowGroup, Transaction
